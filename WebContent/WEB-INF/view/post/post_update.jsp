	...
	<div class="container px-4 px-lg-5 my-5">
		<div class="text-center text-white">
			...
			<p class="lead fw-normal text-white-50 mb-0">
				<a href="./PostSelectAll?gameNumber=${gameDTO.gameNumber}">${gameDTO.gameName}</a></p>
		</div>
	</div>
</header>
...
<div class="container px-4 px-lg-5">
	<div class="viewBox">
		<form name="inPost" id="upPost" action="./PostUpdateView.do?gameNumber=${gameDTO.gameNumber}&postNumber=${postDTO.postNumber}" method="post" enctype="application/x-www-form-urlencoded">
			<div>
				<label for="memId"></label><input type="text" name="memId" id="memId" class="postIn" disabled
					value="${postDTO.memId}" readonly>
				<label for="postPasswd"></label>
				<label for="postTopic">&nbsp; 글 주제 : </label>
				<input type="radio" id="postTopic" name="postTopic" value="정보">정보 &nbsp;
				<input type="radio" id="postTopic" name="postTopic" value="스포">스포 &nbsp;
				<input type="radio" id="postTopic" name="postTopic" value="질문">질문 &nbsp;
				<input type="radio" id="postTopic" name="postTopic" value="잡담">잡담
			</div>
			<p class="m-0"></p>
			<div>
				<label for="postTitle"></label><input type="text" name="postTitle" id="postTitle" class="insertTitle" 
					value="${postDTO.postTitle}">
			</div>
			<p class="m-0"></p>
			<div class="text-start">
				<label for="postContent"></label><textarea class="textbox" cols="10" rows="8" name="postContent" id="postContent">${postDTO.postContent}</textarea>
			</div>
			<p class="m-0"></p>
